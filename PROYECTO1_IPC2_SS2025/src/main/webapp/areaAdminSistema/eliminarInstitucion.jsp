<%-- 
    ...
    Created on : 23/09/2025, 12:05:16
    Author     : eleaz
--%>
...
<head>
    <meta charset="UTF-8">
    <title>Eliminar Instituciones</title>
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-danger" 
                                ...
                                data-bs-target="#eliminarModal${institucion.idInstitucion}">
                            Eliminar
                        </button>

                        <!-- Modal de confirmación -->
                        <div class="modal fade" id="eliminarModal${institucion.idInstitucion}" tabindex="-1" aria-hidden="true">
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                  <p>¿Estás seguro de eliminar la institución <strong>${institucion.nombreInstitucion}</strong>?</p>
                              </div>
                              <div class="modal-footer">
                                  <form method="POST" action="${pageContext.request.contextPath}/EliminarInstitucionServlet">
