<%-- 
    ...
    Created on : 18/09/2025, 12:26:45
    Author     : eleaz
--%>
    ...
    <body onload="loadPage('home')"> <!-- Carga home.jsp al inicio -->
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
            <div class="container-fluid">
                <a class="navbar-brand" href="#" onclick="loadPage('home')">HYRULE EVENTS</a>
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="usuariosDropdown">
                                <li><a class="dropdown-item" href="#" onclick="loadPage('crearUsuario')">Registrar nueva institución</a></li>
        ...
        <footer class="bg-dark text-white text-center py-3 mt-5">
            © 2025 Administracion del sistema. Todos los derechos reservados.
        </footer>
