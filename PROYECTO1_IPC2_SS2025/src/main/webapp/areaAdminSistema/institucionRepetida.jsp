<%-- 
    Document   : institucionRepetida
    Created on : 23/09/2025, 08:59:48
    Author     : eleaz
--%>
...
<head>
    ...
    <title>Institución Repetida</title>
...
<body>
    <div class="message-box">
        <h1>Institución Repetida</h1>
        <p>Ya existe una institución con ese nombre.</p>
        <a href="vistaAdminSistema.jsp" class="btn btn-warning">Volver a la página principal</a>
    </div>
</body>
</html>
